...
const ExhibitionCard = ({ exhibition }) => {
  ...
  const getImageUrl = () => {
    if (exhibition.image) {
      return `${API_URL}/images/${exhibition.image}`;
    }
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-[#bb86fc]/20">
        <div className="relative h-48 bg-gradient-to-br from-[#bb86fc]/20 to-[#6b46c1]/20">
          ...
          <div className="absolute top-4 right-4">
            <span
              className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(exhibition.status)}`}
            >
        ...
        <div className="p-6">
          ...
          <div className="space-y-2 mb-4">
            <div className="flex items-center text-sm text-gray-700">
              <svg
                className="w-4 h-4 mr-2 text-[#bb86fc]"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <div className="flex items-center text-sm text-gray-700">
              ...
              {exhibition.availableTickets} / {exhibition.totalTickets} tickets
              available
            </div>
          </div>
