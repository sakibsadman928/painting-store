...
const ProductCard = ({ product }) => {
  ...
  return (
    ...
    >
      <div className="group flex items-center justify-center px-2 overflow-hidden">
        <img
          className="group-hover:scale-105 transition-transform duration-300 w-full max-w-36 h-32 object-cover rounded"
          src={getImageUrl()}
      ...
      <div className="text-gray-500/60 text-sm">
        ...
        <p className="text-xs text-gray-500 mb-2">
          {product.totalRatings || 0} review
          {product.totalRatings !== 1 ? "s" : ""}
        </p>
          ...
          <div className="text-[#bb86fc]">
            {product.stock === 0 ? (
              ...
              <div className="flex items-center justify-center gap-2 md:w-20 w-16 h-[34px] bg-[#bb86fc]/25 rounded select-none">
                ...
                <span className="w-5 text-center text-[#bb86fc] font-medium">
                  {currentQuantity}
                </span>
                <button
                  onClick={(e) => handleQuantityChange(e, 1)}
