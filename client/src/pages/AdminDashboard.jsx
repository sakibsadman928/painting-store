  ...
  const AddExhibitionForm = () => {
    ...
    return (
      <form
        ...
        className="space-y-4 bg-white p-4 rounded border"
      >
        <h3 className="text-lg font-medium text-[#6b46c1]">
          Add New Exhibition
        </h3>
        <input
          type="text"
  ...
  const DataTable = ({ data, type, onUpdate }) => {
    const handleDelete = async (id, endpoint) => {
      ...
      const data = await apiCall(endpoint, {
        ...
        body: JSON.stringify({
          [type === "products" ? "id" : "exhibitionId"]: id,
        }),
      });
                ...
                <tr key={item._id} className="hover:bg-gray-50">
                  ...
                  {type === "orders" && (
                    <>
                      ...
                      <td className="px-4 py-4 text-sm font-medium text-[#bb86fc]">
                        ${item.amount}
                      </td>
                      <td className="px-4 py-4 text-sm">
    ...
    <div className="min-h-screen bg-gray-100 p-4">
      <div className="max-w-7xl mx-auto">
        ...
        {activeSection === "products" && (
          <DataTable data={products} type="products" onUpdate={fetchProducts} />
        )}
        {activeSection === "orders" && (
          <DataTable data={orders} type="orders" onUpdate={fetchOrders} />
        )}
        ...
        {activeSection === "tickets" && (
          <DataTable data={tickets} type="tickets" onUpdate={fetchTickets} />
        )}
