    ...
    <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
      ...
      <div className="mb-4">
        ...
        <textarea
          ...
          placeholder={
            hasAlreadyRated ? "Your review" : "Write your review (optional)"
          }
          disabled={hasAlreadyRated}
      ...
      return (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">
            When you purchase paintings, they will appear here.
          </p>
        </div>
      );
    }
          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="text-right">
                ...
                <p className="text-lg font-semibold text-[#bb86fc] mt-1">
                  ${order.amount}
                </p>
              </div>
            </div>
                ...
                {order.items.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                            ...
                            <img
                              ...
                              onError={(e) => {
                                ...
                                e.target.parentElement.innerHTML =
                                  '<span class="text-gray-500 text-xs text-center px-1">Product not found</span>';
                              }}
                            />
                          ) : (
                            <span className="text-gray-500 text-xs text-center px-1">
                      ...
                      {order.status === "Shipped" && !isProductDeleted && (
                        <button
    ...
    if (tickets.length === 0) {
      return (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">
            When you purchase exhibition tickets, they will appear here.
          </p>
        </div>
      );
    }
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">
                    {isExhibitionDeleted
                      ? "Exhibition no longer available"
                      : exhibition.title}
                  </h3>
                  <p className="text-sm font-medium text-[#bb86fc]">
                    Ticket #{ticket.ticketNumber}
                  </p>
                </div>
                <div className="text-right">
                  <span
                    className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(ticket.ticketStatus)}`}
                  >
                    {ticket.ticketStatus.charAt(0).toUpperCase() +
                      ticket.ticketStatus.slice(1)}
                  </span>
                  <p className="text-lg font-semibold text-[#bb86fc] mt-1">
                    ${ticket.totalAmount}
                  </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t pt-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-1">
                    ...
                    {isExhibitionDeleted
                      ? "N/A"
                      : exhibition.eventTime
                        ? formatTime(exhibition.eventTime)
                        : "N/A"}
                  </p>
                  <p className="text-sm text-gray-600">
                    <span className="font-medium">Venue:</span>{" "}
                    {isExhibitionDeleted ? "N/A" : exhibition.venue || "N/A"}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-600 mb-1">
