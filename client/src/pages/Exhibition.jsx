...
const Exhibition = () => {
  ...
  const fetchCurrentMonthExhibitions = async () => {
    try {
      ...
      const response = await fetch(`${API_URL}/api/exhibition/current`);
    ...
    <div className="mt-16 px-6 md:px-16 lg:px-24 xl:px-32 mb-16">
      <div className="flex flex-col items-center w-full mb-12">
        ...
        <p className="text-gray-600 text-center max-w-2xl">
          Discover and experience captivating art exhibitions featuring works
          from talented artists. Join us for an inspiring journey through
