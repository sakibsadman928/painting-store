...
const singleProduct = async (req, res) => {
  try {
    ...
    //ProductService is imported from services/productService.js and getProductById is a method
    // defined in that service which fetches a single product based on the provided productId.
    // The controller then checks if the product exists and returns it in the response.
    //  If the product is not found, it returns an appropriate error message.
...
const updateProduct = async (req, res) => {
  try {
    ...
    // Checking to see if new images are uploaded. If yes, delete old images and update with new ones.
    // If not, keep the old images as they are.
